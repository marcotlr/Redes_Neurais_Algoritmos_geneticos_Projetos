...
def cria_candidato_liga(Elementos_Possiveis, tamanho_liga,pesos_atomicos, limite=100, Valor_minimo=5):
    """
    ...
    for chave, peso in zip(elementos, pesos):
        candidato[chave] = {"Peso": peso , 
                        "Valor": peso* Elementos_Possiveis[chave],
                        "Peso Atomico": peso * pesos_atomicos[chave]}
    
    return candidato

 
def cria_populacao_liga(tamanho_pop, tamanho_liga, Elementos_Possiveis, pesos_atomicos, limite = 100, Valor_minimo = 5):
    """
    ...
    for _ in range(tamanho_pop):
        populacao.append(cria_candidato_liga(Elementos_Possiveis, tamanho_liga, pesos_atomicos))
    return populacao
...
def funcao_objetivo_liga(candidato):
    ...
    valor_total = 0
    peso_atomico_total = 0 

    for elemento in candidato:
        valor_total += candidato[elemento]["Valor"]
        peso_atomico_total += candidato[elemento]["Peso Atomico"]
        
    return valor_total/peso_atomico_total
...
def calcula_liga(candidato):
    ...
    for nome_item in elementos:
            ...
            peso_atomico_liga += candidato[nome_item]["Peso Atomico"]
    return peso, valor, peso_atomico_liga
...
def cruzamento_uniforme_dicionario(pai, mae, chance_de_cruzamento, elementos_possiveis, pesos_atomicos):
    '''
        ...
        for i in range(tamanho):
            ...
            if random.choice([True, False]):
                ...
                filho1[gene_mae] = {
                    ...
                    "Peso Atomico": dados_pai["Peso"] * pesos_atomicos[gene_mae]
                }
                filho2[gene_pai] = {
                    "Peso": dados_mae["Peso"],  # Peso da mãe
                    "Valor": dados_mae["Peso"] * elementos_possiveis[gene_pai],
                     "Peso Atomico": dados_mae["Peso"] * pesos_atomicos[gene_pai]
...
def mutacao_elementos_liga(populacao, chance_de_mutacao, elementos_possiveis, pesos_atomicos):
    '''
    ...
    for individuo in populacao:
        if random.random() < chance_de_mutacao:
            ...
            individuo[elemento_novo]["Peso Atomico"] = individuo[elemento_novo]["Peso"] * pesos_atomicos[elemento_novo]

def mutacao_pesos_liga(populacao, chance_de_mutacao, elementos_possiveis, pesos_atomicos):
    '''
    ...
    for individuo in populacao:
        if random.random() < chance_de_mutacao:
            ...
            individuo[elemento_1]["Peso Atomico"] = individuo[elemento_1]["Peso"] *  pesos_atomicos[elemento_1]
            individuo[elemento_2]["Peso Atomico"] = individuo[elemento_2]["Peso"] *  pesos_atomicos[elemento_2]
